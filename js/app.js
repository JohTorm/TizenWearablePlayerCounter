...
(function() {
    ...
    function init() {
        ...
        textbox.addEventListener("click", function() {
            var box = document.querySelector("#content-text1");
        ...
        var textbox1 = document.querySelector("#contents1");
        ...
        textbox1.addEventListener("click", function() {
            var box = document.querySelector("#content-text2");

           var number1 = box.innerHTML;
           number1++;
           box.innerHTML = number1;
